...
namespace Solucoes.Api.App.Migrations
{
    ...
    [Migration("20231101220710_Inclusão Reunião E ReuniãoAção Correção nomes tabelas")]
    partial class InclusãoReuniãoEReuniãoAçãoCorreçãonomestabelas
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Solucoes.Modelo.Entidades.Reuniao", b =>
                {
                    ...
                    b.Property<DateTime?>("HoraAgendamentoFinal")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("HoraAgendamentoInicial")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("Reuniao", (string)null);
                });

            modelBuilder.Entity("Solucoes.Modelo.Entidades.ReuniaoAcao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ReuniaoAcao", (string)null);
                });
            ...
            modelBuilder.Entity("Solucoes.Modelo.Entidades.ReuniaoAcao", b =>
                {
                    b.HasOne("Solucoes.Modelo.Entidades.Reuniao", "Reuniao")
                        .WithMany("ReuniaoAccoes")
                        .HasForeignKey("ReuniaoId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Solucoes.Modelo.Entidades.Setor", "Setor")
                        .WithMany("ReuniaoAcoes")
            ...
            modelBuilder.Entity("Solucoes.Modelo.Entidades.Reuniao", b =>
                {
                    b.Navigation("ReuniaoAccoes");
                });

            modelBuilder.Entity("Solucoes.Modelo.Entidades.Setor", b =>
                {
                    b.Navigation("ReuniaoAcoes");
                });
